...
extension on Translations {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'libraries.groupings.artists': return 'Artists';
...
extension on _StringsDe {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'libraries.groupings.artists': return 'Künstler';
...
extension on _StringsIt {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'libraries.groupings.artists': return 'Artisti';
...
extension on _StringsNl {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'libraries.groupings.artists': return 'Artiesten';
			case 'libraries.groupings.albums': return 'Albums';
...
extension on _StringsSv {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'libraries.groupings.artists': return 'Artister';
			case 'libraries.groupings.albums': return 'Album';
...
extension on _StringsZh {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'libraries.groupings.artists': return '艺术家';
